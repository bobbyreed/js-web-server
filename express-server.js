 ...
 * This middleware serves static files from the 'public' directory: app.use(express.static('public'));
 * 
 ...
 *    that don't change based on request parameters sent to the server. This middleware automatically
 ...
 * This middleware parses incoming JSON requests and puts the parsed data in req.body: app.use(express.json());
 * 
 ...
 *    Similarly, app.post(), app.put(), etc. handle other HTTP methods. This is alot of the beauty of using express.
 *    Typical bits like HTTP methods are already built as methods off of app.
 */
 ...
 *    send JSON, res.json() is more explicit about the intent to send JSON data. Typing like this keeps us safe!
 * 
 ...
 * A: It's a placeholder. This is where we will place the logic for our RESTful API server
 * 
 ...
 * 
 * Q: Do we need to use RegEx with express?
 * 
 * A: Nope. Regex/URL parsing (trimmedPath from our post-server), is handled by express. Yay!
 * 
 ...
 *    while query parameters are used for filtering or sorting.
 * 
